...
<head>
	...
	<style type="text/css">
		...
		div#div0 {background-color:#888888;height:100%;width:20%;float:left;}
		div#div2 {backgrount-color:#345313;height:200;width:80%;float:right;}
		div#div3 {background-color:#3f3431;height:100;width:80%;float:right;}
		div#menu {background-color:#000352;height:300px;width:80%;float:right;}
		div#graph {background-color:#ffff99;height:400px;width:80%;float:right;}
		div#chart {background-color:#cccc77;width:80%;float:right;}
...
<form methord=post action="test10.jsp" name="form1" id="form1">
	...
	<div style='height:150;width:20%;background-color:#cccccc;float:left'>视图<br>
	<select name="viewname" onchange="getViews()">
		<option value="total">total</option>
	</select></div>
	<div style='height:150;width:20%;background-color:#cccccc;float:left'>维度<br>
	<select name="views">
		<option value="all">all</option>
	</select></div>
	<div style='height:150;width:20%;background-color:#cccccc;float:left'>区间<br>
	...
	<div style='height:150;width:20%;background-color:#cccccc;float:left' id='date2'>
	<div id="date1">
	请输入开始日期：<br />
	...
	<div style='height:150;width:20%;background-color:#cccccc;float:left' id='fine'>粒度<br>
...
<script>
	for (abc in total)
	{
		document.getElementById("div3").innerHTML += abc
		document.getElementById("div3").innerHTML += ":"+total[abc]+"<br>"
	}
</script>
